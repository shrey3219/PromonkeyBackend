 ...
 */
const sendClientEmailUpdateEmail = async (newEmail, name) => {
  const mailOptions = {
    from: process.env.EMAIL_FROM,
    to: newEmail,
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 24px; border: 1px solid #e0e0e0; border-radius: 8px;">
        ...
        <p>Your ProMonkey client portal login email has been updated by the admin.</p>
...
/**
 * @param {string} toEmail   - Client's (possibly updated) email
 * @param {string} name      - Client's name
 * @param {string} password  - New plain-text password
 */
const sendClientPasswordUpdateEmail = async (toEmail, name, password) => {
  const mailOptions = {
    from: process.env.EMAIL_FROM,
    to: toEmail,
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 24px; border: 1px solid #e0e0e0; border-radius: 8px;">
        ...
        <p>Your ProMonkey client portal password has been reset by the admin. Here are your new credentials:</p>
